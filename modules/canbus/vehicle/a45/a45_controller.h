...
class A45Controller final : public VehicleController {
 public:

  explicit A45Controller() {};

  virtual ~A45Controller();
 ...
 private:
  // control protocol
  Acc1225* acc1_225_ = nullptr;
  Acc2250* acc2_250_ = nullptr;
  Acc3251* acc3_251_ = nullptr;
  Epscontrol300* eps_control_300_ = nullptr;
