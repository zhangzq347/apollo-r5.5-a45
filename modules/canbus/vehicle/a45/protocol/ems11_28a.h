...
class Ems1128a : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  Ems11_28a::Ems_acc_ecgpovrdType ems_acc_ecgpovrd(const std::uint8_t* bytes, const int32_t length) const;
};
