...
class Ems13279 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  double ems_accpedalposact(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Ems13_279::Ems_erroraccpedalposactType ems_erroraccpedalposact(const std::uint8_t* bytes, const int32_t length) const;
};
