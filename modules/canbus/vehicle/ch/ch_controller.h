 ...
 *
 * 此模块用于ChController类的声明、类函数声明，需新增输出报文函数声明（20200508-张智清）
 *****************************************************************************/
...
class ChController final : public VehicleController {
 ...
 private:
  ...
  A45EPScontrol300* a45_eps_control_300_ = nullptr;  //新增A45的EPS_Control报文（20200508-张智清）
  A45ACC1225* a45_acc_1_225_ = nullptr;  //新增A45的ACC1报文（20200508-张智清)
  A45ACC2250* a45_acc_2_250_ = nullptr;  //新增A45的ACC2报文（20200508-张智清)
  A45ACC3251* a45_acc_3_251_ = nullptr;  //新增A45的ACC3报文（20200508-张智清)
